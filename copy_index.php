			...
			<div class="row" style="display: block;">
				...
				<tbody id="table-body">
						...
						<!--<tr id="r_<?php //echo $j;?>">
							...
							<input type="hidden" name="billno" value=<?php// echo $bill['billno']+1;?>>
							<td><select name="productName[]" id="productName_<?php //echo $j;?>" class="form-control"  onchange="getprice<?php //echo $j;?>(this)"><option value=0>Select Item</option><?php //for($i=0;$i<5;$i++){?><option value="<?php //echo $price1[$i];?>"><?php //echo $name[$i];?></option><?php //}?></select></td>			
							<td><input type="number" name="qty[]" id="quantity_<?php //echo $j;?>" class="form-control quantity" autocomplete="off"></td>
							<td><input type="number" name="price[]" id="price_<?php //echo $j;?>" class="form-control price" autocomplete="off" readonly></td>
               
							<script>
							//alert("<?php //echo $reslt?>");
                            //var name=document.getElementById("productCode_1").value;
                            //document.getElementById("price_1").value=name;
                            </script>
							<td><input type="number" name="total[]" id="total_<?php //echo $j;?>" class="form-control total" autocomplete="off" readonly></td>
                            </tr>-->
